            ...
            <div className="container container_home">
                <div className="container_tables table-responsive">
                    <div className="container f_g row">
                        <div className="container_filter col-12">
                            <div className="input-group caixa-in">
                                <div className="ct_l ct-input">
                                ...
                                <div className="ct_button_header">
                        ...
                        <div className="container_cadastro col-12">
                            <Link to='/cadastro' class="btn button_cadastro btn-success">Novo Cadastro</Link>
                        </div>
                    </div>
                    ...
                    {(Aluno.length == 0) && 
                        <div className="container container_loading">
                            <div class="loading alert alert-warning" role="alert">
                                Nenhum aluno foi encontrado. Tente Novamente
                            </div>
                        </div>
                    }
                        <thead>
                            ...
                            {Aluno.map(aluno => (
                                <tr key={aluno.aluno_idAluno}>
                                    ...
                                    <th>
                                        ...
                                        <Link className="button_al btn btn-info" to={{pathname: `/modal/${aluno.aluno_idAluno}`}}>
